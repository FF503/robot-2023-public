...
public class ShopFieldConfig extends FieldConfig {
        ...
        final double Y_tag2Totag1 = 66; //66
        final double Y_tag3Totag2 = 65.25; //65.5

        final double BLUE_X_tag6ToChargeCorner = 74.587; //74.587
        final double BLUE_Y_tag6ToChargeCorner = -19.17; //-19.17
        final double BLUE_ChargeWidth = 75.926; //75.926
        final double BLUE_ChargeLength = 94; //94
        final double BLUE_X_ChargeBottomRightCornertoPieceD = 85; //85
        final double BLUE_Y_ChargeBotomRightCornertoPieceD = 22.5; //22.5
        final double BLUE_Y_PieceDtoPieceC = 49.75; //49.75
        final double BLUE_Y_PieceCtoPieceB = 48; //48
        final double BLUE_Y_PieceBtoPieceA = 48; //48


        // RED ALLIANCE VALUES
        final double RED_X_tag1ToChargeCorner = 74.587; //74.587
        final double RED_Y_tag1ToChargeCorner = -19.17; //-19.17
        final double RED_ChargeWidth = 75.926; //75.926
        final double RED_ChargeLength = 94; //94
        final double RED_X_ChargeBottomRightCornertoPieceD = 85; //85
        final double RED_Y_ChargeBotomRightCornertoPieceD = 22.5; //85
        final double RED_Y_PieceDtoPieceC = 49.75; //49.75
        final double RED_Y_PieceCtoPieceB = 48; //48
        final double RED_Y_PieceBtoPieceA = 48; //48


    public ShopFieldConfig() {
