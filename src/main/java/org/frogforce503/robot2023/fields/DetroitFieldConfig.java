...
public class DetroitFieldConfig extends FieldConfig {
        ...
        final double X_OriginToTag8 = 42; //40.5
        final double Y_OriginToTag8 = 42.75; //42.19
        final double Y_tag8Totag7 = 66.5; //66
        final double Y_tag7Totag6 = 66.25; //66
        final double X_OriginTotag3 = 41; //40.45
        final double Y_OriginTotag3 = 42.25; //42.19
        final double Y_tag2Totag1 = 66.5; //66
        final double Y_tag3Totag2 = 66.5; //65.5

        final double BLUE_X_tag6ToChargeCorner = 73.5; //74.587
        final double BLUE_Y_tag6ToChargeCorner = -17.5; //-19.17
        final double BLUE_ChargeWidth = 75.5; //75.926
        final double BLUE_ChargeLength = 96.25; //94
        final double BLUE_X_ChargeBottomRightCornertoPieceD = 87.5; //85
        final double BLUE_Y_ChargeBotomRightCornertoPieceD = 22.75; //22.5
        ...
        final double RED_Y_tag1ToChargeCorner = -18; //-19.17
        final double RED_ChargeWidth = 75; //75.926
        final double RED_ChargeLength = 96.5; //94
        final double RED_X_ChargeBottomRightCornertoPieceD = 87; //85
        final double RED_Y_ChargeBotomRightCornertoPieceD = 25; //85
        final double RED_Y_PieceDtoPieceC = 48; //49.75
        final double RED_Y_PieceCtoPieceB = 47.5; //48
        final double RED_Y_PieceBtoPieceA = 48; //48


    public DetroitFieldConfig() {
