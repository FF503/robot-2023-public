...
public class BigBangFieldConfig extends FieldConfig {
/***
     * -------------------
    ...
    final double X_OriginToTag8 = 39.75; // 40.5
    final double Y_OriginToTag8 = 42.5; // 42.19
    final double Y_tag8Totag7 = 66.375; // 66
    final double Y_tag7Totag6 = 67; // 66
    final double X_OriginTotag3 = 40.5; // 40.45
    final double Y_OriginTotag3 = 42.5; // 42.19
    final double Y_tag2Totag1 = 66.5; // 66
    final double Y_tag3Totag2 = 66; // 65.5

    final double BLUE_X_tag6ToChargeCorner = 73.5; // 74.587
    final double BLUE_Y_tag6ToChargeCorner = -21; // -19.17
    final double BLUE_ChargeWidth = 74.5; // 75.926
    final double BLUE_ChargeLength = 97.75; // 94
    final double BLUE_X_ChargeBottomRightCornertoPieceD = 88; // 85
    final double BLUE_Y_ChargeBotomRightCornertoPieceD = 26.5; // 22.5
    final double BLUE_Y_PieceDtoPieceC = 48.5; // 49.75
    final double BLUE_Y_PieceCtoPieceB = 47.5; // 48
    final double BLUE_Y_PieceBtoPieceA = 48; // 48

    // RED ALLIANCE VALUES
    final double RED_X_tag1ToChargeCorner = 74.5; // 74.587
    final double RED_Y_tag1ToChargeCorner = -17.5; // -19.17
    final double RED_ChargeWidth = 75; // 75.926
    final double RED_ChargeLength = 96.75; // 94
    final double RED_X_ChargeBottomRightCornertoPieceD = 87; // 85
    final double RED_Y_ChargeBotomRightCornertoPieceD = 22.5; // 85
    final double RED_Y_PieceDtoPieceC = 47.5; // 49.75
    final double RED_Y_PieceCtoPieceB = 48.5; // 48
    final double RED_Y_PieceBtoPieceA = 48; // 48

    public BigBangFieldConfig() {
