...
public class MarcFieldConfig extends FieldConfig {
/***
     * -------------------
    ...
    final double BLUE_Y_ChargeBotomRightCornertoPieceD = 23; // 22.5
    ...
    // RED ALLIANCE VALUES
    final double RED_X_tag1ToChargeCorner = 76.5; // 74.587
    final double RED_Y_tag1ToChargeCorner = -15.5; // -19.17
    final double RED_ChargeWidth = 74.5; // 75.926
    final double RED_ChargeLength = 97; // 94
    final double RED_X_ChargeBottomRightCornertoPieceD = 88.5; // 85
    final double RED_Y_ChargeBotomRightCornertoPieceD = 28; //v 85
    final double RED_Y_PieceDtoPieceC = 48; // 49.75
    final double RED_Y_PieceCtoPieceB = 48; // 48
    final double RED_Y_PieceBtoPieceA = 48.5; // 48

    public MarcFieldConfig() {
