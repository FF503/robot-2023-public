...
public class StatesFieldConfig extends FieldConfig {
    ...
    final double X_OriginToTag8 = 40; // 40.5
    ...
    final double BLUE_Y_tag6ToChargeCorner = -19.25; // -19.17
    final double BLUE_ChargeWidth = 76.5; // 75.926
    final double BLUE_ChargeLength = 97.25; // 94
    final double BLUE_X_ChargeBottomRightCornertoPieceD = 89; // 85
    final double BLUE_Y_ChargeBotomRightCornertoPieceD = 24.5; // 22.5
    final double BLUE_Y_PieceDtoPieceC = 48; // 49.75
