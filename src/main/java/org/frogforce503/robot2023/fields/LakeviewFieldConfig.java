...
public class LakeviewFieldConfig extends FieldConfig {
        ...
        final double X_OriginTotag3 = 41.5; //40.45
        final double Y_OriginTotag3 = 42; //42.19
        final double Y_tag2Totag1 = 66; //66
        final double Y_tag3Totag2 = 66; //65.5

        final double BLUE_X_tag6ToChargeCorner = 74; //74.587
        final double BLUE_Y_tag6ToChargeCorner = -15.5; //-19.17
        ...
        final double RED_X_ChargeBottomRightCornertoPieceD = 90; //85
        final double RED_Y_ChargeBotomRightCornertoPieceD = 23.5; //85
        final double RED_Y_PieceDtoPieceC = 48; //49.75
        final double RED_Y_PieceCtoPieceB = 48; //48
        final double RED_Y_PieceBtoPieceA = 47.5; //48


    public LakeviewFieldConfig() {
