...
public class RainbowFieldConfig extends FieldConfig {
/***
     * -------------------
    ...
    final double BLUE_X_tag6ToChargeCorner = 74.25; // 74.587
    final double BLUE_Y_tag6ToChargeCorner = -18.75; // -19.17
    final double BLUE_ChargeWidth = 76; // 75.926
    final double BLUE_ChargeLength = 97; // 94
    final double BLUE_X_ChargeBottomRightCornertoPieceD = 87; // 85
    final double BLUE_Y_ChargeBotomRightCornertoPieceD = 24; // 22.5
    ...
    // RED ALLIANCE VALUES
    final double RED_X_tag1ToChargeCorner = 75; // 74.587
    final double RED_Y_tag1ToChargeCorner = -18.5; // -19.17
    final double RED_ChargeWidth = 76.5; // 75.926
    final double RED_ChargeLength = 97; // 94
    final double RED_X_ChargeBottomRightCornertoPieceD = 86; // 85
    final double RED_Y_ChargeBotomRightCornertoPieceD = 24; // 85
    final double RED_Y_PieceDtoPieceC = 48; // 49.75
    final double RED_Y_PieceCtoPieceB = 48; // 48
    final double RED_Y_PieceBtoPieceA = 48; // 48

    public RainbowFieldConfig() {
