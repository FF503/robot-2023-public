...
public class NewtonFieldConfig extends FieldConfig {
        ...
        final double X_OriginToTag8 = 40.5; //40.45
        final double Y_OriginToTag8 = 42.5; //42.19
        final double Y_tag8Totag7 = 66.25; //66
        final double Y_tag7Totag6 = 66.25; //66
        final double X_OriginTotag3 = 40.25; //40.45
        final double Y_OriginTotag3 = 42.25; //42.19
        final double Y_tag2Totag1 = 67.0; //66
        final double Y_tag3Totag2 = 66.0; //65.5

        final double BLUE_X_tag6ToChargeCorner = 74.5; //74.587
        final double BLUE_Y_tag6ToChargeCorner = -17.0; //-19.17
        final double BLUE_ChargeWidth = 76.0; //75.926
        final double BLUE_ChargeLength = 97.0; //94
        final double BLUE_X_ChargeBottomRightCornertoPieceD = 88.0; //85
        final double BLUE_Y_ChargeBotomRightCornertoPieceD = 22.5; //22.5
        final double BLUE_Y_PieceDtoPieceC = 48.0; //49.75
        final double BLUE_Y_PieceCtoPieceB = 48.25; //48
        final double BLUE_Y_PieceBtoPieceA = 48.0; //48


        // RED ALLIANCE VALUES
        final double RED_X_tag1ToChargeCorner = 74.5; //74.587 missing in newton
        final double RED_Y_tag1ToChargeCorner = -17.0; //-19.17 << may be off
        final double RED_ChargeWidth = 76.25; //75.926
        final double RED_ChargeLength = 97.0; //94
        final double RED_X_ChargeBottomRightCornertoPieceD = 87.0; //85 missing in newton
        final double RED_Y_ChargeBotomRightCornertoPieceD = 22.5; //85
        final double RED_Y_PieceDtoPieceC = 48.0; //49.75
        final double RED_Y_PieceCtoPieceB = 48.0; //48
        final double RED_Y_PieceBtoPieceA = 48.0; //48


    public NewtonFieldConfig() {
    ...
    //    boolean blue = 
        ...
        TAG_4 = TAG_3.setId(4)
        .plusTag(new Translation2d(Units.inchesToMeters(-26.19), Units.inchesToMeters(-91.55)));
